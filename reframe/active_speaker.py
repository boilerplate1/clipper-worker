...
Ported from the OpenShorts reframe engine (active_speaker.py).
"""
...
def speaker_xs(held, centres, crop_w, orig_w, n_frames, fps, window_s=WINDOW_SECONDS):
...
def verdicts_for_scene(video_path, start_f, end_f, fps, centres):
    ...
    from engine.reframe import split_layout
...
def decode_activity(video_path, start_s, duration_s, boxes, fps, window_s=WINDOW_SECONDS):
